...
cdef class Session:
    ...
    @classmethod
    def fromRootFile(root_path):
        ses = Session()
        ses.ptr = SessionFactory.create_py_session_from_root_path(root_path)
        return ses
    ...
    def __init__(self,
        ...
        self.ptr = SessionFactory.create_py_session_from_config(config)
