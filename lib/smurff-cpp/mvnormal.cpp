...
std::pair<VectorXd, MatrixXd> CondNormalWishart(const int N, const MatrixXd &NS, const VectorXd &NU, const VectorXd &mu, const double kappa, const MatrixXd &T, const int nu)
{
    int nu_c = nu + N;
