...
void printActualResults(double actualRmseAvg, const std::shared_ptr<std::vector<smurff::ResultItem>> actualResults)
{
   std::cout << "   double expectedRmseAvg = "
...
#define PRINT_ACTUALS printActualResults(actualRmseAvg, actualResults);
   ...
   , HIDE_MATRIX_TESTS)
{
   ...
   // Pre-calculated results with single-threaded Debug master 6b6491b79751aaa469f9471e727b6630a7aa8a82
   double expectedRmseAvg = 0.1781219186285102;
   std::vector<ResultItem> expectedResults =
      {
         { { 0, 0,  }, 1, 1.2144143534342033, 1.3571704491800070, 11.1559227955743783,  },
         { { 0, 1,  }, 2, 2.0062004683241521, 2.1400108920633043, 8.1191126843766686,  },
         { { 0, 2,  }, 3, 2.8202422773824605, 2.9144254693583678, 7.5454222652864393,  },
         { { 0, 3,  }, 4, 3.5496306015596528, 3.7715708558520862, 8.7957345860142535,  },
         { { 2, 0,  }, 9, 10.0473131361773014, 8.8009513354308009, 11.3007342150798635,  },
         { { 2, 1,  }, 10, 9.8308758197406920, 9.9653551788785162, 7.5103693823257531,  },
         { { 2, 2,  }, 11, 11.3888457136569983, 10.9355087052231532, 6.7140204326150483,  },
         { { 2, 3,  }, 12, 11.9754279424480572, 12.0465072866699749, 6.9740665785840275,  },
      }; 
   ...
   , HIDE_MATRIX_TESTS)
{
   ...
   // Pre-calculated results with single-threaded Debug master 6b6491b79751aaa469f9471e727b6630a7aa8a82
   double expectedRmseAvg = 0.1882211003775618;
   std::vector<ResultItem> expectedResults =
      {
         { { 0, 0,  }, 1, 2.0784939520070433, 1.4347252698721193, 8.9777389617764278,  },
         { { 0, 1,  }, 2, 1.9601928034997640, 2.1533106372592901, 7.2100841040766879,  },
         { { 0, 2,  }, 3, 3.5087543713627993, 2.9261880270676506, 6.2121599319173271,  },
         { { 0, 3,  }, 4, 4.0108270806854396, 3.8308403194973253, 10.0856668967415608,  },
         { { 2, 0,  }, 9, 8.3276775726846513, 8.8299520945170347, 10.5530670806058637,  },
         { { 2, 1,  }, 10, 10.2057702041982328, 9.9481443476180758, 10.1599613755907665,  },
         { { 2, 2,  }, 11, 11.2998783396935014, 10.9336593680178460, 10.2300539057519817,  },
         { { 2, 3,  }, 12, 12.4626975092226768, 12.0292859369947784, 7.5570959112258675,  },
      };
   ...
   , HIDE_MATRIX_TESTS)
{
   ...
   // Pre-calculated results with single-threaded Debug master 6b6491b79751aaa469f9471e727b6630a7aa8a82
   double expectedRmseAvg = 0.1867200507573905;
   std::vector<ResultItem> expectedResults =
      {
         { { 0, 0,  }, 1, 0.5978144781614423, 1.3829382632139686, 8.7045688895212709,  },
         { { 0, 1,  }, 2, 2.1090220354170395, 2.1097261603357658, 6.1087451125415955,  },
         { { 0, 2,  }, 3, 2.9300529249850422, 2.9797319287778459, 8.9118461739760875,  },
         { { 0, 3,  }, 4, 3.9831543991206813, 3.7254061923370698, 9.3275450079719828,  },
         { { 2, 0,  }, 9, 9.0959391056464334, 8.9181795952911376, 8.6395730005734013,  },
         { { 2, 1,  }, 10, 9.9537756883687329, 9.9820848929456467, 7.9577699538390450,  },
         { { 2, 2,  }, 11, 11.5518804841651495, 10.9456655301588626, 9.7054188265622781,  },
         { { 2, 3,  }, 12, 11.9976593444361193, 12.1856156160593123, 9.0706017073289402,  },
      };
   ...
   , HIDE_MATRIX_TESTS)
{
   ...
   // Pre-calculated results with single-threaded Debug master 6b6491b79751aaa469f9471e727b6630a7aa8a82
   double expectedRmseAvg = 0.1145369518217537;
   std::vector<ResultItem> expectedResults =
      {
         { { 0, 0,  }, 1, 0.3147770433555519, 1.2194508961963841, 10.3271190481218085,  },
         { { 0, 1,  }, 2, 1.5738511984885415, 2.1206293123488646, 6.6668950272252170,  },
         { { 0, 2,  }, 3, 3.2200329301191828, 2.9565412867253311, 6.8791239993172759,  },
         { { 0, 3,  }, 4, 3.9663706170800666, 3.8308924310178534, 10.9262078435357068,  },
         { { 2, 0,  }, 9, 8.8325153327435562, 8.9473529636448550, 6.9601929373422529,  },
         { { 2, 1,  }, 10, 10.2325415669539446, 9.9538238749702117, 7.5997577180678393,  },
         { { 2, 2,  }, 11, 11.6655892737409452, 10.9732457484335022, 8.6257883821485919,  },
         { { 2, 3,  }, 12, 12.4433649803842812, 12.0783186774570552, 7.2189464766638789,  },
      };
