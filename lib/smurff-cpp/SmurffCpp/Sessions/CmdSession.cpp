...
void CmdSession::setFromArgs(int argc, char** argv)
{
    ...
    struct argp_option options[] =
    {
        ...
        {"side-info",        FEATURES	, "FILE,FILE,FILE FILE,FILE,FILE",  0, "side info for rows and cols, use \"none\" if no features"},
        {"aux-data",         FEATURES	, "FILE,FILE,FILE FILE,FILE,FILE",  0, "side info for rows and cols, use \"none\" if no features"},
